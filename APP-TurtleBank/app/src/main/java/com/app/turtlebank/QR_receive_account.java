...
public class QR_receive_account extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qr_account_view);
    ...
    private void updateRecyclerView(JSONArray dataArray) {
        QR_receive_account.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                ...
                recyclerViewbankaccount.setLayoutManager(new LinearLayoutManager(QR_receive_account.this));

                QRaccountAdapter QRaccountAdapter = new QRaccountAdapter(bankAccounts, QR_receive_account.this);
                recyclerViewbankaccount.setAdapter(QRaccountAdapter);
            }
        });
    }
    ...
    public void define(){
        recyclerViewbankaccount = QR_receive_account.this.findViewById(R.id.recyclerview_bank_account);
    }
