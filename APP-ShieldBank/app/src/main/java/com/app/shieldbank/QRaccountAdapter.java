...
public class QRaccountAdapter extends RecyclerView.Adapter<QRaccountAdapter.ViewHolder> {
    ...
    public QRaccountAdapter(ArrayList<BankAccount> myData, Activity activity) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.qr_account_cardview, parent, false);
