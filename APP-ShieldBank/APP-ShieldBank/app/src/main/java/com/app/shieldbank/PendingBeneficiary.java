...
public class PendingBeneficiary extends AppCompatActivity  implements Badapter.OnItemClickListener {
        ...
        JsonObjectRequest jsonArrayRequest=new JsonObjectRequest(Request.Method.POST, finalurl, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        badapter.setOnItemClickListener(PendingBeneficiary.this);
                    }
