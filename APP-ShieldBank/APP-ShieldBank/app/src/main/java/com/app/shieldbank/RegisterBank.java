...
public class RegisterBank extends AppCompatActivity {
    ...
    public void register(View view)
    {
        ...
        EditText inputPhone=findViewById(R.id.signup_phone_editText);
        EditText inputaccountPW=findViewById(R.id.signup_accountPW_editText);
        ...
        String accountPW = inputaccountPW.getText().toString().trim();
        String hAccountPW = hashPassword(accountPW);
